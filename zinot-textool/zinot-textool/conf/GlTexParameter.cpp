...
namespace Textool
{
bool GlTexParameter::fromJsonObject(const QJsonObject & jsonObj)
{
...
void GlTexParameter::parseWrapping(const QJsonObject & jsonObj)
{
...
void GlTexParameter::parseMagFilter(const QJsonObject & jsonObj)
{
...
void GlTexParameter::parseMinFilter(const QJsonObject & jsonObj)
{
