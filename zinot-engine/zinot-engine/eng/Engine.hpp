...
{
private:
   std::unique_ptr<Window> mainWindow; /// Main Window pointer. Engine is owner of main window. The window is created after call to main() method.
   std::unique_ptr<Scene> mainScene;   /// Main Scene pointer. Engne is owner of main scene. The scene is default displayed in Main Window.
public:
   /**
